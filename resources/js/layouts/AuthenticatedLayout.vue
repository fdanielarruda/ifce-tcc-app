...
<template>
    <div class="bg-gray-100 dark:bg-gray-900 min-h-screen flex">
        ...
        >
            ...
            <nav
                class="flex-1 px-2 py-1 space-y-1 flex flex-col overflow-y-auto"
            ...
            >
                ...
                <div class="space-y-1 mt-auto pb-4">
                    <div class="flex justify-center">
                        <NavLink
                            href="#"
                            @click.prevent="applyTheme('light')"
                            :active="!isDark"
                        >
                        ...
                        <NavLink
                            href="#"
                            @click.prevent="applyTheme('dark')"
                            :active="isDark"
                        >
                            <MoonIcon
                                :class="[
                                    'h-5 w-5',
                                    { 'text-white': isDark, 'text-gray-400': !isDark },
                                ]"
                            />
                        </NavLink>
                    </div>
        ...
        <div class="fixed top-2 left-2 z-50">
            <button
                @click="toggleSidebar"
                class="p-2 rounded-md text-gray-400 hover:text-gray-500 focus:outline-none border bg-white dark:bg-gray-800 dark:border-gray-800 shadow-sm"
        ...
        <main class="flex-1 overflow-auto" :class="mainContentClasses">
            <div class="mx-auto">
                <div
